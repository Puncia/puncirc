...
ui::channel_bar::channel_bar(QWidget * parent) : p_widget(parent)
{
	ui.setupUi(this);
	
	ch_b1 = std::make_shared<ui_base::p_channel_button>(this);
	ui.gridLayout->addWidget(ch_b1.get(), 0, 1, Qt::AlignTop | Qt::AlignLeft);


}

void ui::channel_bar::button_pressed(Qt::MouseButton button)
{

}

ui::channel_bar::~channel_bar()
{
